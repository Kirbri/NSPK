...
public class AboutCompanyPage {
    ...
    public AboutCompanyPage checkComplianceAboutHeadHugeText() {
        StringBuilder actualText = new StringBuilder("Акционерное общество «Национальная система платежных карт» ")
                .append("(НСПК) — оператор платежной системы «Мир», операционный платежный и клиринговый центр ")
                .append("Системы быстрых платежей (СБП), создано 23 июля 2014 года. 100% акций АО «НСПК» принадлежит ")
                .append(" Центральному банку Российской Федерации");

        aboutHeadHuge.scrollTo().should(text(actualText.toString()));
        return this;
    }

    public AboutCompanyPage checkComplianceAboutHeadColsText() {
        StringBuilder actualText = new StringBuilder("Развитие национальной платежной системы — ключевой фактор ")
                .append("обеспечения суверенитета национального платежного пространства. Национальная платежная ")
                .append("система гарантирует безопасность и бесперебойность проведения внутрироссийских транзакций ")
                .append("по банковским картам.");

        aboutHeadCols.scrollTo().should(text(actualText.toString()));
        return this;
    }

    public AboutCompanyPage checkComplianceAboutHeadFontText() {
        aboutHeadFontText.scrollTo().should(text("Деятельность НСПК регулируется Федеральным законом № 161 «О национальной платежной системе», «Стратегией развития Национальной платежной системы» и «Концепцией создания национальной системы платежных карт»."));
        return this;
    }
    ...
    public AboutCompanyPage checkComplianceAboutMissionText0() {
        aboutMissionText0.scrollTo().should(text("В задачи НСПК входят обеспечение бесперебойности операций по картам международных платежных систем на территории России, построение и развитие российской системы платежных карт, а также обеспечение удобных и безопасных операций через Систему быстрых платежей (СБП), по универсальному QR-коду и с помощью биоэквайринга на территории страны."));
        return this;
    }
    ...
    public AboutCompanyPage checkComplianceAboutMissionText1() {
        aboutMissionText1.scrollTo().should(text("Внутрироссийские операции по картам всех платежных систем, в том числе международных, после 1 апреля 2015 года осуществляются через процессинг операционного платежного и клирингового центра НСПК (ОПКЦ НСПК)."));
        return this;
    }
}