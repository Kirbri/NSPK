...
public class AboutCompanyPage {
    ...
    public AboutCompanyPage openAboutCompanyPage() {
        ...
        $(".ctr-about-head__font.ctr-about-head__font--title").scrollTo().should(text("О компании АО «НСПК»"));
        return this;
    }
    ...
    public AboutCompanyPage complianceAboutMissionText0 () {
        aboutMissionText0.scrollTo().should(text("В задачи НСПК входят обеспечение бесперебойности операций по картам" +
                ...
                "(СБП), по универсальному QR-коду и с помощью биоэквайринга на территории страны."));
        return this;
    }
